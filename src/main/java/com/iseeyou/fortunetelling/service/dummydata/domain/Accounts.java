...
public class Accounts {
    ...
    private void createAccount() {
        ...
        User seer = User.builder()
                ...
                .avatarUrl("https://example.com/seer-avatar.jpg")
                .coverUrl("https://example.com/seer-cover.jpg")
        ...
        User unverifiedSeer = User.builder()
                ...
                .avatarUrl("https://example.com/unverified-seer-avatar.jpg")
        ...
        User customer = User.builder()
                ...
                .avatarUrl("https://example.com/customer-avatar.jpg")
